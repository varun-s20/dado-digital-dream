...
export const Route = createFileRoute("/_site/approach")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "How Fieldcraft designs and builds gardens, pools and bespoke carpentry." },
      { property: "og:title", content: "Studio — Fieldcraft" },
      { property: "og:description", content: "Site-led design, in-house carpentry, planting that belongs." },
    ],
  }),
  ...
  return (
    <>
      ...
      <section className="img-zoom mx-auto max-w-[1600px] px-6 md:px-12">
        <Reveal>
          <img src={studio} alt="Carpenter at the workbench" className="aspect-[16/9] w-full object-cover" />
        </Reveal>
      </section>
